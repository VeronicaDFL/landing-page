...
<nav className=" bg-white dark:bg-orange-400 fixed top-0 right-0 w-full z-20">
  <div className=" sm:place-content-center bg-green-400 max-w-screen-xl flex flex-wrap  justify-between mx-auto p-2">
  
  
    
      <button data-collapse-toggle="navbar-sticky " type="button" className=" fixed top-0 right-2 inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-600 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray dark:hover:text-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-sticky" aria-expanded="false">
  ...
  <div className=" hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-20 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 sm:justify-center">
      <li className="">
